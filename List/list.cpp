...
Шаблонным называется класс, тип полей которого, определяется при создании объекта. При этом он обязательно должен быть указан в угловых скобках после имени класса.

Для того, чтобы сделать класс шаблонным, перед ним достаточно создрать шаблон. Теперь абсолютно все переменные члены класса и его методы, автоматически становятся шаблонными. Любую переменную можно сделать шаблонной как в классе, так и в его методах.
Еслм внутри шаблонного класса объявлены другие классы, то они не являются шаблонными. Несмотря на это, их поля могут быть шаблонного типа, а методы могут использовать шаблонные переменные.

Конкретный тип данных в угловых скобках после имени класса ставится только в том случае, если имя класса означает имя типа, а не имя функции.
*/
}
